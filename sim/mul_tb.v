...
reg clk, clr;
reg [31:0] Mdatain;
parameter Default = 4'b0000, Reg_load1a = 4'b0001, Reg_load1b = 4'b0010, Reg_load2a = 4'b0011, Reg_load2b = 4'b0100, Reg_load3a = 4'b0101, Reg_load3b = 4'b0110, T0 = 4'b0111,T1 = 4'b1000, T2 = 4'b1001, T3 = 4'b1010, 
...
always @(Present_state) // do the required job in each state
	begin
		case (Present_state) // assert the required signals in each clock cycle
			...
			Reg_load1b: begin
				#10 MDRout <= 1; r4en <= 1;	
				#10 MDRout <= 0; r4en <= 0; // initialize R4 with the value $2
			end
			Reg_load2a: begin
				Mdatain <= -6;
				#10 Read <= 1; MDRen <= 1;
			...
			Reg_load2b: begin
				#10 MDRout <= 1; r5en <= 1;
				#10 MDRout <= 0; r5en <= 0; // initialize R5 with the value $4
			end
			Reg_load3a: begin
			...
			T4: begin
				#10 r5out <= 1; op <= 6; ZLOen <= 1; ZHIen <= 1;
				#10 r5out <= 0; ZLOen <= 0; ZHIen <= 0;
			end
			T5: begin
				#10 ZLOout <= 1; LOen <= 1;
				#10 ZLOout <= 0; LOen <= 0;
