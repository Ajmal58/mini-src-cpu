...
reg clk, clr;
reg [31:0] Mdatain;
parameter Default = 4'b0000, Reg_load1a = 4'b0001, Reg_load1b = 4'b0010, Reg_load2a = 4'b0011, Reg_load2b = 4'b0100, Reg_load3a = 4'b0101, Reg_load3b = 4'b0110, T0 = 4'b0111,T1 = 4'b1000, T2 = 4'b1001, T3 = 4'b1010, T4 = 4'b1011;
...
always @(Present_state) // do the required job in each state
	begin
		case (Present_state) // assert the required signals in each clock cycle
			...
			Reg_load1b: begin
				#10 MDRout <= 1; r7en <= 1;	
				#10 MDRout <= 0; r7en <= 0; // initialize R2 with the value $2
			end
			Reg_load2a: begin
				Mdatain <= 32'h0000004;
				#10 Read <= 1; MDRen <= 1;
			...
			Reg_load2b: begin
				#10 MDRout <= 1; r6en <= 1;
				#10 MDRout <= 0; r6en <= 0; // initialize R3 with the value $4
			end
			Reg_load3a: begin
